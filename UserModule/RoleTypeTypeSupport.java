...
public class RoleTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UserModule::RoleType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RoleTypeTypeSupport _singleton
    = new RoleTypeTypeSupport();
    ...
    */
    public static RoleTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static RoleTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RoleTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>RoleType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        RoleType typedSrc = (RoleType) src;
    ...
    protected RoleTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RoleTypeTypeCode.VALUE,RoleType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
