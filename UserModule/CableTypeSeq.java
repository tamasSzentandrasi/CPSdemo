...
/**
* A sequence of CableType instances.
*/
public final class CableTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CableTypeSeq() {
        super(CableType.class);
    }

    public CableTypeSeq (int initialMaximum) {
        super(CableType.class, initialMaximum);
    }

    public CableTypeSeq (Collection elements) {
        super(CableType.class, elements);
    }

    public  CableType get(int index) { 
        return (CableType) super.get(index); 
    }
