...
/**
* A sequence of UserStruct instances.
*/
public final class UserStructSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UserStructSeq() {
        super(UserStruct.class);
    }

    public UserStructSeq (int initialMaximum) {
        super(UserStruct.class, initialMaximum);
    }

    public UserStructSeq (Collection elements) {
        super(UserStruct.class, elements);
    }

    public  UserStruct get(int index) { 
        return (UserStruct) super.get(index); 
    }
