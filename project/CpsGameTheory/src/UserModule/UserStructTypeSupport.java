...
public class UserStructTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UserModule::UserStruct";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UserStructTypeSupport _singleton
    = new UserStructTypeSupport();
    ...
    */
    public static UserStructTypeSupport get_instance() {
        return _singleton;
    }

    public static UserStructTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UserStructTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>UserStruct</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UserStruct typedDst = (UserStruct) destination;
        UserStruct typedSrc = (UserStruct) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment +=UserModule.CableTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(0) ;
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += UserModule.CableTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment +=CdrPrimitiveType.INT.getMaxSizeSerialized(0) ;
        ...
        Object sample) 
    {
        ...
        UserStruct typedSrc = (UserStruct) sample;
        ...
        if (typedSrc.role != null) {
            ...
            for(int i1__ = 0; i1__< 2; ++i1__){
                ...
                currentAlignment += UserModule.RoleTypeTypeSupport.get_instance().get_serialized_sample_size(
                    endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.role[i1__]);
            }
        ...
        currentAlignment += UserModule.CableTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.transmissionType);
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.role != null) {
                ...
                for(int i1__ = 0; i1__< 2; ++i1__){
                    ...
                    UserModule.RoleTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.role[i1__], dst, false, encapsulation_id,true,endpoint_plugin_qos);
                }
            ...
            memberId = 97078951;
            memberLengthPosition = dst.writeMemberId((int)memberId);
            dst.writeDouble(typedSrc.distance);
            dst.writeMemberLength(memberLengthPosition, true);

            memberId = 136653229;
            memberLengthPosition = dst.writeMemberId((int)memberId);
            UserModule.CableTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.transmissionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            dst.writeMemberLength(memberLengthPosition, true);

            memberId = 255660682;
            memberLengthPosition = dst.writeMemberId((int)memberId);
            dst.writeInt(typedSrc.switchRef);
            dst.writeMemberLength(memberLengthPosition, true);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UserStruct typedDst = (UserStruct) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    for(int i1__ = 0; i1__< 2; ++i1__){
                        ...
                        typedDst.role[i1__] = (UserModule.RoleType)UserModule.RoleTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.role[i1__], src, false, true, endpoint_plugin_qos);     
                    }

                    break;
                    case 97078951:
                    typedDst.distance = src.readDouble();
                    break;
                    case 136653229:
                    typedDst.transmissionType = (UserModule.CableType)UserModule.CableTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.transmissionType, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 255660682:
                    typedDst.switchRef = src.readInt();
                    break;
                    default:
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    for(int i1__ = 0; i1__< 2; ++i1__){
                        ...
                        UserModule.RoleTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    }
                    ...
                    case 136653229:
                    UserModule.CableTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UserStruct typedDst = (UserStruct) sample;
    ...
    int mask) {
        return new UserStructDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UserStructDataReader(native_reader, listener, mask, this);   
    ...
    protected UserStructTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UserStructTypeCode.VALUE,UserStruct.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UserStructTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UserStructTypeCode.VALUE,UserStruct.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
