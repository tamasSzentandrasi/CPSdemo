...
public class CableTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UserModule::CableType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CableTypeTypeSupport _singleton
    = new CableTypeTypeSupport();
    ...
    */
    public static CableTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static CableTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CableTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CableType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        CableType typedSrc = (CableType) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = CableType.valueOf(ordinal);
            if (dst == null) {
                SampleAssignabilityProperty ap =
                ((DefaultEndpointData)endpoint_data).getSampleAssignabilityProperty();

                if (ap.acceptUnknownEnumValue) {
                    dst = CableType.valueOf(
                        0);
                } else {
    ...
    protected CableTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CableTypeTypeCode.VALUE,CableType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
