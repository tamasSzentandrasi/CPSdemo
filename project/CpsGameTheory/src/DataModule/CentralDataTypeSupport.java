...
public class CentralDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DataModule::CentralData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CentralDataTypeSupport _singleton
    = new CentralDataTypeSupport();
    ...
    */
    public static CentralDataTypeSupport get_instance() {
        return _singleton;
    }

    public static CentralDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CentralDataTypeCode.VALUE;
    }

    public Object create_data() {
        return CentralData.create();
    }
    ...
    * <code>this</code> is not a <code>CentralData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CentralData typedDst = (CentralData) destination;
        CentralData typedSrc = (CentralData) source;
        ...
        Object sample) 
    {
        ...
        CentralData typedSrc = (CentralData) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CentralData typedDst = (CentralData) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    for(int i1__ = 0; i1__< 7; ++i1__){
                        ...
                        typedDst.prices[i1__] = src.readDouble();
                    }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CentralData typedDst = (CentralData) sample;
    ...
    int mask) {
        return new CentralDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CentralDataDataReader(native_reader, listener, mask, this);   
    ...
    protected CentralDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CentralDataTypeCode.VALUE,CentralData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CentralDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CentralDataTypeCode.VALUE,CentralData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
