...
/**
* A sequence of EnergyType instances.
*/
public final class EnergyTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EnergyTypeSeq() {
        super(EnergyType.class);
    }

    public EnergyTypeSeq (int initialMaximum) {
        super(EnergyType.class, initialMaximum);
    }

    public EnergyTypeSeq (Collection elements) {
        super(EnergyType.class, elements);
    }

    public  EnergyType get(int index) { 
        return (EnergyType) super.get(index); 
    }
