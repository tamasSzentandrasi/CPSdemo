...
public class EnergyTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DataModule::EnergyType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EnergyTypeTypeSupport _singleton
    = new EnergyTypeTypeSupport();
    ...
    */
    public static EnergyTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static EnergyTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EnergyTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>EnergyType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        EnergyType typedSrc = (EnergyType) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = EnergyType.valueOf(ordinal);
            if (dst == null) {
    ...
    protected EnergyTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EnergyTypeTypeCode.VALUE,EnergyType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
