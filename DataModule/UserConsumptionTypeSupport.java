...
public class UserConsumptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DataModule::UserConsumption";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UserConsumptionTypeSupport _singleton
    = new UserConsumptionTypeSupport();
    ...
    */
    public static UserConsumptionTypeSupport get_instance() {
        return _singleton;
    }

    public static UserConsumptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UserConsumptionTypeCode.VALUE;
    }

    public Object create_data() {
        return UserConsumption.create();
    }
    ...
    * <code>this</code> is not a <code>UserConsumption</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UserConsumption typedDst = (UserConsumption) destination;
        UserConsumption typedSrc = (UserConsumption) source;
        ...
        Object sample) 
    {
        ...
        UserConsumption typedSrc = (UserConsumption) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 7; ++i1__){
                ...
                dst.writeDouble(typedSrc.consumptions[i1__]);
            }
            ...
            for(int i1__ = 0; i1__< 7; ++i1__){
                ...
                dst.writeDouble(typedSrc.productions[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UserConsumption typedDst = (UserConsumption) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    for(int i1__ = 0; i1__< 7; ++i1__){
                        ...
                        typedDst.consumptions[i1__] = src.readDouble();
                    }
                    ...
                    for(int i1__ = 0; i1__< 7; ++i1__){
                        ...
                        typedDst.productions[i1__] = src.readDouble();
                    }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UserConsumption typedDst = (UserConsumption) sample;
    ...
    int mask) {
        return new UserConsumptionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UserConsumptionDataReader(native_reader, listener, mask, this);   
    ...
    protected UserConsumptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UserConsumptionTypeCode.VALUE,UserConsumption.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UserConsumptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UserConsumptionTypeCode.VALUE,UserConsumption.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
