...
/**
* A sequence of CentralData instances.
*/
public final class CentralDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CentralDataSeq() {
        super(CentralData.class);
    }

    public CentralDataSeq (int initialMaximum) {
        super(CentralData.class, initialMaximum);
    }

    public CentralDataSeq (Collection elements) {
        super(CentralData.class, elements);
    }

    public  CentralData get(int index) { 
        return (CentralData) super.get(index); 
    }
