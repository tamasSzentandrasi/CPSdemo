...
/**
* A sequence of UserConsumption instances.
*/
public final class UserConsumptionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UserConsumptionSeq() {
        super(UserConsumption.class);
    }

    public UserConsumptionSeq (int initialMaximum) {
        super(UserConsumption.class, initialMaximum);
    }

    public UserConsumptionSeq (Collection elements) {
        super(UserConsumption.class, elements);
    }

    public  UserConsumption get(int index) { 
        return (UserConsumption) super.get(index); 
    }
